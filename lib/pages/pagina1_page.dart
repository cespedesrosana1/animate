...
import 'package:animacion1/pages/navegacion_page.dart';
import 'package:animacion1/pages/twitter_page.dart';
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: (){
              Navigator.push(context,
                MaterialPageRoute(builder: (BuildContext context)=> TwitterPage() )  );
            },
          ),
          ...
          SlideInLeft(
            ...
            child: IconButton(
              ...
              onPressed: (){
                Navigator.push(context, 
                 CupertinoPageRoute(builder: (BuildContext context)=> Pagina1Page() )  );
              },
            ),
          ),
